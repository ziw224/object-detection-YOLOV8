...
def train(args):
    ...
    for e in range(args.num_epochs):
        data_loader.reset_batch_pointer()
        train_loss.reset_state()  # Reset the training loss for each epoch
        ...
        for batch in range(data_loader.num_batches):
            ...
            print("Epoch {}/{}, Batch {}/{} - Loss: {:.3f}, Time/batch: {:.3f}, Mean Error: {}, Final Error: {}"
                  .format(e + 1, args.num_epochs, batch + 1, data_loader.num_batches, 
                          loss, end - start, mean_error, final_error))
